      ...
      <div className="flex bg-base-100 justify-between mx-auto  container min-h-20  ">
        ...
        <div className="navbar-center hidden lg:flex self-center">
          <ul className="menu menu-horizontal  px-1 text-sm">
            ...
            <li>
              <details>
                <summary className="navlist  font-semibold">
                  Our Service
                </summary>
                <ul className="p-2 text-xs min-w-72 rounded-sm">
                  <li>
                    <a>Maritime rental of containers to shiping lines</a>
                  </li>
                  <li>
                    <a>Oneway Movement - Shipping Lines</a>
                  </li>
                  <li>
                    <a>
                      Any Container Type , for any period , anywhere in the
                      world
                    </a>
                  </li>
                  <li>
                    <a>Maritime containers buying and selling</a>
                  </li>
                  <li>
                    <a>Container Storage and Repairs</a>
                  </li>
                  <li>
                    <a>Container Inspections</a>
                  </li>
                </ul>
              </details>
            </li>
